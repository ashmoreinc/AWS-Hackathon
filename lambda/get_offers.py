...
def lambda_handler(event, context):
    try:
        ...
        connection_type = body.get('connection_type')  # 'wifi' or 'mobile'
        ...
        # wifi -> at home -> online offers
        # mobile -> on the go -> high_street offers
        ...
        # Score offers: preferred type gets +50 boost
        scored_offers = []
        for offer in offers:
